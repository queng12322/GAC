    ...
    for index in "${!gpu_ids[@]}"; do
        ...
        for layer_id in $(seq $start_layer_id $end_layer_id); do
            ...
            nohup python game_theory.py \
                   ...
                   --game_theory_result_path "/mnt/petrelfs/quxiaoye/yuzengqi/GAC/game_theory_results_mc/" \
                   --task_type 'question_answer' > ./output_log/mc/nohup_layer_${layer_id}.log 2>&1 &
        done
    done
