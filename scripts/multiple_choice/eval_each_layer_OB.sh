...
do
    ...
    do
        ...
        do
            mkdir -p ./mc_eval_output_log_${dataset_name}
            folder_path="./mc_eval_output_log_${dataset_name}"
            ...
            do
                ...
                nohup python main.py \
                    ...
                    --dataset $dataset_name > ./mc_eval_output_log_${dataset_name}/nohup_${layer_with_underscore}_aug_${augmentation}.log 2>&1 &
