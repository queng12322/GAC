...
do
    ...
    do
        ...
        do
            mkdir -p ./pope_eval_output_log_${dataset_name}
            folder_path="./pope_eval_output_log_${dataset_name}"
            ...
            nohup python main_pope.py \
                ...
                --pope-type $dataset_name \
                --calibrate 0 > ./pope_eval_output_log_${dataset_name}/nohup_layer_${layer_with_underscore}.log 2>&1 &
    ...
    modified_results=$(python post_process_each_layer_pope.py --folder_path "$folder_path")
    max_index=-1
