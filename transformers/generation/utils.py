...
class GenerationMixin:
    ...
    def generate(
        ...
        **kwargs,
        ...
        # add
        head_comb = kwargs.pop("head_comb", None)
        output_label = kwargs.pop("output_label", None)
        save_path = kwargs.pop("game_theory_result_path", None)
    ...
    def _sample(
        ...
        **model_kwargs,
        ...
        while self._has_unfinished_sequences(
            ...
            # forward pass to get next token
            outputs = self(**model_inputs, return_dict=True, head_comb=head_comb)
            ...
            pdb.set_trace()
            #########ADD##########
            if head_comb is not None and output_label is not None and save_path is not None:
                # The values of probabilities are too small and need to be enlarged
            ...
            elif head_comb is None and output_label is None and save_path is None:
                pass
            elif head_comb is not None and output_label is None and save_path is None:
                pass
            else:
                raise ValueError("Head_comb, Output_Label, and save_path need to be both empty or not empty at the same time")
            ######################
