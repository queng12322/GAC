...
parser = argparse.ArgumentParser(description="Extract ACC-all values and sort them.")
...
sorted_acc_values = sorted(acc_values.items(), key=lambda x: int(x[0].split('_')[-3]))
